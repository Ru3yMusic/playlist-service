 ...
 *
 * <p>Detected by {@code @SpringBootTest} via component scanning. Prevents
 * {@link JwtConfig#jwtPublicKey} from trying to decode the placeholder value in
 * {@code application-test.yml}, because {@link JwtConfig#jwtPublicKey} is annotated
 * with {@code @ConditionalOnMissingBean(PublicKey.class)}.
 *
...
public class TestPublicKeyConfig {
    ...
    @Bean
    public PublicKey playlistTestPublicKey(KeyPair testKeyPair) {
